...
#  	if ($self->o('dump_tsv') && $self->o('dump_gtf') && $self->o('dump_gff3') && $self->o('dump_embl') && $self->o('dump_genbank') && $self->o('dump_fasta') ) {
  	if ($self->o('f_dump_gff3') && $self->o('f_dump_embl') && $self->o('f_dump_genbank')) {
    	$pipeline_flow  = ['predump_gff3', 'dump_embl' , 'dump_genbank'];
  	} elsif ($self->o('f_dump_gff3') && $self->o('f_dump_embl')) {
    	$pipeline_flow  = ['predump_gff3', 'dump_embl'];
  	} elsif ($self->o('f_dump_gff3') && $self->o('f_dump_genbank')) {
    	$pipeline_flow  = ['predump_gff3', 'dump_genbank'];
  	} elsif ($self->o('f_dump_embl') && $self->o('f_dump_genbank')) {
    	$pipeline_flow  = ['dump_embl', 'dump_genbank'];
  	} elsif ($self->o('f_dump_gff3')) {
    	$pipeline_flow  = ['predump_gff3'];
  	} elsif ($self->o('f_dump_embl')) {
    	$pipeline_flow  = ['dump_embl'];
  	} elsif ($self->o('f_dump_genbank')) {
    	$pipeline_flow  = ['dump_genbank'];
	}
